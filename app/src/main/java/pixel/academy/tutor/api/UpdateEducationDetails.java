...
public class UpdateEducationDetails
{
	...
	public UpdateEducationDetails(Context context , OnTaskCompleted listener)
	{
	...
	public void execute(final String user_id)
	{
		...
		final String URL = context.getResources().getString(R.string.pixelServerBaseUrl)
				+ context.getResources().getString(R.string.pixelServerEducationUrl);
			...
			public void onResponse(String response)
			{
				try
				{
					...
					for (int i=0; i< jsonArray.length(); i++)
					{
						...
						helper.update(TABLE_EDUCATION, obj.getInt("id"), obj.getInt("sync_status"));
					}
				}
...

		{
			...
			protected Map<String, String> getParams()
			{
				...
				try
				{
					...
					params.put(JSON_TAG, helper.composeEducationJSON());
				}
